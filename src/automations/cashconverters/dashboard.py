...
<section class="view" id="activity"><div class="section-head"><div><h2>Heures habituelles des ajouts</h2><div class="muted">Répartition de toutes les nouveautés détectées, heure de Bruxelles</div></div></div>
 <div class="panel"><p class="explain">L’heure affichée est celle de notre détection. Avec un scan toutes les 15 minutes, l’ajout réel sur le site a normalement eu lieu dans les 15 minutes précédentes. L’historique fiable commence à partir de l’activation de cette vue.</p>{_hour_chart(discoveries)}</div></section>
